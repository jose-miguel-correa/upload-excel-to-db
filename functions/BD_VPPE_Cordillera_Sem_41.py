# BD_VPPE_Cordillera_Sem_41

import pandas as pd
from connection import conn, cursor

def process_BD_VPPE_Cordillera_Sem_41(file_path):
    xls_path = './files/BD VPPE Cordillera Sem 41_.xlsx'
    sheet = "Final VPPE Cordillera"
    table_name = 'BD_VPPE_Cordillera_Sem_41'

# Informe_Area_Puerto_41_Alertas_para_Ejecutivos

import pandas as pd
from connection import conn, cursor


def process_Informe_Area_Puerto_41_Alertas_para_Ejecutivos(file_path):
    xls_path = './files/Informe Área Puerto 41.xlsx'
    sheet = "3 alertas para Ejecutivos"
    table_name = 'Informe_Area_Puerto_41_Alertas_para_Ejecutivos'

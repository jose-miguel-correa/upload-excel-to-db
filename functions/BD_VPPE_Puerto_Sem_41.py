# BD_VPPE_Puerto_Sem_41

import pandas as pd
from connection import conn, cursor

def process_BD_VPPE_Puerto_Sem_41(file_path):
    xls_path = './files/BD VPPE Puerto Sem 41.xlsx'
    sheet = "Final VPPE Puerto"
    table_name = 'BD_VPPE_Puerto_Sem_41'

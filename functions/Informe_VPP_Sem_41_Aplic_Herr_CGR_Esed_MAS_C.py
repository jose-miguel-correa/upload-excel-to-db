# Informe_VPP_Sem_41_Aplic_Herr_CGR_Esed_MAS_C

import pandas as pd
from connection import conn, cursor


def process_Informe_VPP_Sem_41_Aplic_Herr_CGR_Esed_MAS_C(file_path):
    xls_path = './files/Informe VPP SEM 41.xlsx'
    sheet = "Aplic Herr CGR Esed MAS+C"
    table_name = 'Informe_VPP_Sem_41_Aplic_Herr_CGR_Esed_MAS_C'

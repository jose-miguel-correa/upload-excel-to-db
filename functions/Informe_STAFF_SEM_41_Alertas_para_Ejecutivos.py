# Informe_STAFF_SEM_41_Alertas_para_Ejecutivos

import pandas as pd
from connection import conn, cursor


def process_Informe_STAFF_SEM_41_Alertas_para_Ejecutivos(file_path):
    xls_path = './files/Informe STAFF SEM 41.xlsx'
    sheet = "3 Alertas para Ejecutivos"
    table_name = 'Informe_STAFF_SEM_41_Alertas_para_Ejecutivos'

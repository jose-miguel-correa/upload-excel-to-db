# Informe_VPPE_Cordillera_Sem_41_Alertas_para_Ejecutivos

import pandas as pd
from connection import conn, cursor


def process_Informe_VPPE_Cordillera_Sem_41_Alertas_para_Ejecutivos(file_path):
    xls_path = './files/Informe VPPE Cordillera Sem 41_.xlsx'
    sheet = "3 alertas para Ejecutivos"
    table_name = 'Informe_VPPE_Cordillera_Sem_41_Alertas_para_Ejecutivos'

# Informe_VPM_SEM_41_Alertas_para_Ejecutivos

import pandas as pd
from connection import conn, cursor


def process_Informe_VPM_SEM_41_Alertas_para_Ejecutivos(file_path):
    xls_path = './files/Informe VPM SEM 41.xlsx'
    sheet = "5 alertas para Ejecutivos"
    table_name = 'Informe_VPM_SEM_41_Alertas_para_Ejecutivos'
